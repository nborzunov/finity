...
function Pomodoro() {
    const { isPaused, schema, order, getPercentage, getTime, getSession, toggle, skip, resetTimer } = useContext(TimerContext)
    ...
    return (
        <>
            ...
            <Box display="flex" alignItems="center" justifyContent="center" m="4">
                <RoundButton icon={Icons.Next} title="Skip" onClick={skip} />
